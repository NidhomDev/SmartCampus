...
/**
 * 工具类
 * @title SmartCampusUtil.java
 * @author guohk
 * @version v1.0
 * @date 2018年11月9日 上午1:24:07
 */
public class SmartCampusUtil {
	...
	private static final Logger logger = LoggerFactory.getLogger(SmartCampusUtil.class);
